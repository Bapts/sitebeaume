		...
		<div class="container">
			...
			<div class="four columns offset-by-one page-sidebar">
				...
				<ul id="blog-categories">
					...
					<li><span class="icon-angle-right"></span><a href="backend3.php">2 Rooms Appartment</a></li>
					...
					<li class="current-backend"><span class="icon-angle-right"></span><a href="backend6.php">Large Business Suite</a></li>
